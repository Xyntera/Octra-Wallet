# Octra Wallet v1.0.0 Release Notes

## Summary

Octra Wallet v1.0.0 is the first production Android APK release of the Flutter
native mobile wallet with local PVAC privacy operations. The APK packages native
Octra wallet-core libraries and performs privacy proof/decrypt work on-device.
