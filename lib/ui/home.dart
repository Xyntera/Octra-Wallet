  ...
  Widget build(BuildContext context) {
    return CupertinoTabScaffold(
      tabBar: CupertinoTabBar(
        ...
        activeColor: const Color(0xFF0A84FF), // Blue
        items: const [
...
class _DashboardTabState extends State<DashboardTab> {
            ...
            child: Center(
              child: Text(
                ...
                style: GoogleFonts.inter(
                  fontSize: 150, // Responsive size would be better, but fixed for now
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text("Octra™", style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w600, color: const Color(0xFF111111))),
                      Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text("Synced", style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w500, color: const Color(0xFF111111))),
                          ],
                        ),
                      )
                    ],
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          Text("TOTAL BALANCE", style: GoogleFonts.inter(fontSize: 12, fontWeight: FontWeight.w600, color: const Color(0xFF666666), letterSpacing: 1)),
                          const SizedBox(height: 12),
                          // Balance Display with Blur Support
                          _buildBlurrableBalance(walletCtrl),
                          const SizedBox(height: 12),
                          Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              const Icon(CupertinoIcons.circle_grid_hex, size: 16, color: Color(0xFF666666)),
                              const SizedBox(width: 8),
                              Text("OCT Token", style: GoogleFonts.inter(fontSize: 14, color: const Color(0xFF666666), fontWeight: FontWeight.w500)),
                            ],
                          ),
                        ],
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                // Toggle private blur logic?
                                // Assuming WalletController has a state or local state.
                                // For visual sync with "Private Mode" described in HTML.
                                // HTML Logic: "if active -> blur balance"
                                // We can implement a local toggle for the blur effect.
                                setState(() {
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      width: 32, height: 18,
                                      decoration: BoxDecoration(
                                        color: _isPrivateMode ? const Color(0xFF111111) : const Color(0xFFE0DFDB),
                                        borderRadius: BorderRadius.circular(999),
                                      ),
                                      child: Stack(
                                        children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Text("Private Mode", style: GoogleFonts.inter(fontSize: 13, color: const Color(0xFF666666), fontWeight: FontWeight.w500)),
                                  ],
                                ),
                              ),
                            )
                ...
                // Bottom padding for TabBar which is overlay in HTML but we use CupertinoTabScaffold
  ...
  // Local state for privacy toggle
  bool _isPrivateMode = false;

  Widget _buildBlurrableBalance(WalletController ctrl) {
     // Format: $ 14,250 .00
     // We use OCT value.
     final parts = ctrl.publicBalance.toStringAsFixed(2).split('.');
     final whole = parts[0];
     ...
     return AnimatedOpacity(
       ...
       child: ImageFiltered(
         ...
         child: RichText(
          text: TextSpan(
            style: GoogleFonts.inter(color: const Color(0xFF111111), fontSize: 56, fontWeight: FontWeight.w500, letterSpacing: -1, height: 1),
            children: [
              const TextSpan(text: "\$", style: TextStyle(fontSize: 24, color: Color(0xFF666666), textBaseline: TextBaseline.alphabetic)), // Using $ as per mockup, or OCT symbol? Mockup shows $ then OCT token label below.
              TextSpan(text: whole),
              TextSpan(text: ".$decimal", style: const TextStyle(fontSize: 32, color: Color(0xFFB0B0B0))),
            ],
          ),
         ),
       ),
  ...
  Widget _buildModernButton({required String label, required bool isPrimary, required VoidCallback onTap}) {
    return CupertinoButton(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isPrimary ? const Color(0xFF111111) : const Color(0xFFEAE8E3), // Primary Black, Secondary Beige/Grey
          borderRadius: BorderRadius.circular(999),
          border: isPrimary ? null : Border.all(color: const Color(0x0D000000)),
        ),
        child: Center(
          child: Text(
            label, 
            style: GoogleFonts.inter(
              color: isPrimary ? const Color(0xFFF8F6F1) : const Color(0xFF111111), 
              fontSize: 16, 
